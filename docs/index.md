...
- Want to run those targets on RunPod: [How to run training on RunPod](how-to/runpod-training.md)
- Want to run the same training targets on a remote Windows WSL machine: [How to run training on a remote Windows WSL box](how-to/remote-wsl-training.md)
