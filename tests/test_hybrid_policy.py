...
def test_build_benchmark_weighted_hybrid_policy_prefers_matching_history_runs() -> None:
    policy = build_benchmark_weighted_hybrid_policy(
        active_models=[
            ...
            {"name": "transformer_modernbert_base", "display_name": "ModernBERT-base"},
            ...
            "runs": [
                {
                    ...
                    "models": [
                        ...
                        {"name": "transformer_modernbert_base", "status": "ok"},
                ...
                },
                {
                    ...
                    "models": [
                        ...
                        },
                        {
                            ...
                            "review_recall_at_precision_75": 0.90,
                            "pr_auc": 0.93,
                        },
                        {
                            ...
                            "status": "ok",
                            "production_ready": True,
                            "auto_recall_at_precision_95": 0.55,
                            "review_recall_at_precision_75": 0.86,
                            "pr_auc": 0.88,
                        },
                        {
                            ...
                            "status": "ok",
                            "production_ready": False,
                            "auto_recall_at_precision_95": 0.58,
    ...
    assert by_name["transformer_modernbert_base"]["weight"] > by_name["transformer_neobert"]["weight"]
...
def test_hybrid_decider_response_uses_benchmark_weighted_policy() -> None:
    decider_result, decision_context = hybrid_decider_response(
        ...
        hybrid_policy={
            ...
            "weights": [
                ...
                {"name": "transformer_neobert", "display_name": "NeoBERT", "weight": 0.45},
            ],
        },
    ...
    assert applied == {
        ...
        "transformer_modernbert_base": pytest.approx(0.45),
...
def test_benchmark_hybrid_policy_entry_uses_history_weighting(
    ...
    scores_by_name = {
        ...
        "transformer_modernbert_base": [0.88, 0.96, 0.20, 0.85, 0.10, 0.82],
    ...
    hybrid_entry = training._benchmark_hybrid_policy_entry(
        ...
        benchmarked_summaries={
            ...
            "transformer_modernbert_base": {"display_name": "ModernBERT-base"},
    ...
    assert hybrid_entry["artifact_path"] is None
    ...
    assert hybrid_entry["policy_metadata"]["decision_source_counts"]["primary_model"] == 2
