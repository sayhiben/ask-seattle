...
def _add_common_arguments(parser: argparse.ArgumentParser, *, include_target: bool) -> None:
    ...
    parser.add_argument(
        ...
        default="transformer_neobert,transformer_modernbert_large",
    )
    ...
    parser.add_argument("--transformer-model-id", default="chandar-lab/NeoBERT")
    parser.add_argument("--transformer-secondary-model-id", default="answerdotai/ModernBERT-large")
